      ...
      <div className="container mx-auto p-6 bg-gray-900 bg-opacity-70 rounded-lg shadow-lg flex flex-col items-center mt-12">
        ...
        <div className="w-full">
          ...
          <p className="mb-6 text-white">
            ...
            smaller photos for better results. Make sure there are not other items in the photo. Try to ensure it is one &apos;shelf&apos; per photo instead of multi-level shelves. For multi-level shelves, upload an image for each shelf.
          </p>
          <h2 className="text-2xl font-semibold mb-2 text-white">What should I do if the app doesn&apos;t detect all books correctly?</h2>
          <p className="mb-6 text-white">
