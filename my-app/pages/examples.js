    ...
    <div className="min-h-screen flex flex-col items-center py-12" style={{ backgroundImage: "url('background.jpg')", backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundAttachment: "fixed", backgroundPosition: "center", color: "#ffffff" }}>
      ...
      <div className="container mx-auto p-6 bg-gray-100 rounded-lg shadow-lg flex flex-col items-center">
        ...
        <div className="w-full">
          ...
          <div className="relative w-full h-64 mb-4 border rounded-lg overflow-hidden cursor-pointer" onClick={() => openModal('/example7.png')}>
          ...
          <div className="relative w-full h-64 mb-4 border rounded-lg overflow-hidden cursor-pointer" onClick={() => openModal('/example8.png')}>
