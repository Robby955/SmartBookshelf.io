...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-orange-300 via-pink-300 to-red-300 flex flex-col items-center justify-center p-4">
            <Head>
                <title>SmartBookShelf.io</title>
            </Head>
            <header className="w-full flex justify-center mb-6">
                <div className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center">
                    <Image src="/logo.png" alt="SmartBookShelf.io Logo" width={200} height={200} />
                </div>
            </header>
            <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-4xl">
                <h1 className="text-4xl font-bold mb-6 text-center">Upload a Book Image</h1>
